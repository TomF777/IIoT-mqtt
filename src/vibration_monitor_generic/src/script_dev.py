"""Script for reading vibration data from MQTT BROKER and send it to INFLUXDB"""
import logging
...
INFLUX_TOKEN = "nQ2CO1J73p7TyhJ7IHdX9__W_V9lNp5gJnwAY5xSxGK3hCMG0-FnMGjSlzh1gCFkVQ6uMXphglVzXYmwNJLZeg=="
INFLUX_ORG = "priv"
INFLUX_PROCESS_DB = "IoT_bucket01"
INFLUX_URL = "http://" + INFLUX_HOST + ":" + INFLUX_PORT
...
def on_message(mqttclient, userdata, message):
    ...
    try:
        ...
        point = (
            ...
            .field("vibration_level", float(round(mqtt_data["VibrationLevel"], 4)))
            .time(time=datetime.utcfromtimestamp(int(mqtt_data["TimeStamp"]) / 1000), write_precision='ms')
        )
...
if __name__ == "__main__":
    ...
    try:
        ...
        mqtt_client.username_pw_set("mqttbroker", "Internet1!")
        #mqtt_client.connect(MQTT_HOST, MQTT_PORT)
        mqtt_client.connect("localhost", 1883)
        #mqtt_client.subscribe(MQTT_TOPIC, MQTT_QOS)
        mqtt_client.subscribe("IoT_Industrial/device01/Vib1", 1)
    except Exception as e:
