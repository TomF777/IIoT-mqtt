...
info_enter "Do you want continue deploy Grafana, Influx, Mosquito and Portainer? It will remove all previous data of old deployment of it [Y/N]:"
read stdin
...
docker compose -p "iot-project" -f ../global_v0.0.1.yml up -d 
